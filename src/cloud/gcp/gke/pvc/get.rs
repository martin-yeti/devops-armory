...
/// Get GKE PersistentVolumeClaim
/// Token, GKE endpoint, namespace need to be provided
pub async fn get_gke_pvc(
    token: String,
    ...
    let get_pvc_request = client
        .get(format!("https://{gke_cluster_endpoint}:443/api/v1/namespaces/{gke_cluster_namespace}/persistentvolumeclaims/{gke_pvc_name}"))
