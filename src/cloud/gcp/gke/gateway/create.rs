...
pub async fn create_gke_gateway(
    token: String,
    ...
    let client = Client::builder()
        ...
        .finish();
    // V1
    let create_gateway_request = client
        .post(format!("https://{gke_cluster_endpoint}:443/apis/gateway.networking.k8s.io/v1/namespaces/{gke_cluster_namespace}/gateways"))
    ...
    let mut req = create_gateway_request;
