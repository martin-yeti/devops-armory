...
use super::models::ServiceAccount;
...
pub async fn patch_service_account(
    ...
    let request = client
        .patch(format!("https://iam.googleapis.com/v1/projects/{project}/serviceAccounts/{service_account_name}"))
        .bearer_auth(&token)
        .insert_header(("Content-Type", "application/json"))
        .timeout(Duration::from_secs(30))
        .send_json(&service_account_data)
        .await
        .expect("Request: PATCH service account failed.");
